...
****************************************************/
/*
 * settings_bt_plotter.h - Bantam Tools CNC Milling Machine Project
...
#ifndef SETTINGS_BT_PLOTTER_H_ONCE
#define SETTINGS_BT_PLOTTER_H_ONCE
#include "main.h"
#ifdef CHABO_PLOTTER
/***********************************************************************/
/**** BT_PLOTTER profile ***************************************/
...
#define M1_TRAVEL_PER_REV           44  //Gt2 22 tooth pully                      // 1tr
#define M1_MICROSTEPS               8                       // 1mi  1,2,4,8,16,32
#define M1_POLARITY                 1                       // 1po  0=normal, 1=reversed

#define M2_MOTOR_MAP                AXIS_Y_EXTERNAL
#define M2_STEP_ANGLE               1.8
#define M2_TRAVEL_PER_REV           47 //circumfrence of Y grit wheel    
#define M2_MICROSTEPS               8
#define M2_POLARITY                 0

#define M3_MOTOR_MAP                AXIS_Z_EXTERNAL
#define M3_STEP_ANGLE               1.8
#define M3_TRAVEL_PER_REV           59 //major diameter of the lever 
#define M3_MICROSTEPS               8
#define M3_POLARITY                 0

#define M4_MOTOR_MAP                AXIS_A_EXTERNAL
#define M4_STEP_ANGLE               1.8
#define M4_TRAVEL_PER_REV           120  // degrees moved per motor rev 13/43 gear ratio on the final version 
...
#define JERK_MAX                    600//400                 // 650 million mm/(min^3)
...
#define LATCH_VELOCITY              100                  // reeeeally slow for accuracy
...
#define X_TRAVEL_MAX                290                 // xtr  travel between switches or crashes
#define X_JERK_MAX                  8000                // xjm
...
#define X_LATCH_BACKOFF             4
#define X_ZERO_BACKOFF              4                 // xzb  mm


#define Y_AXIS_MODE                 AXIS_STANDARD
#define Y_VELOCITY_MAX              13000
#define Y_FEEDRATE_MAX              13000
#define Y_TRAVEL_MIN                175
#define Y_TRAVEL_MAX                0//110
...
#define Y_ZERO_BACKOFF              40
#define Y_LATCH_BACKOFF             4

#define Z_AXIS_MODE                 AXIS_STANDARD
#define Z_VELOCITY_MAX              13000
#define Z_FEEDRATE_MAX              Z_VELOCITY_MAX
#define Z_TRAVEL_MIN                -5
...
#define A_VELOCITY_MAX              5000
#define A_FEEDRATE_MAX              A_VELOCITY_MAX
#define A_TRAVEL_MIN                0  // degrees
#define A_TRAVEL_MAX                360  // same value means infinite, no limit
#define A_JERK_MAX                  (1000*360)
#define A_JERK_HIGH_SPEED           A_JERK_MAX
#define A_RADIUS                    1.0
#define A_HOMING_INPUT              1  // arbitrary since we don't use pin number, must not be zero
#define A_HOMING_DIRECTION          0
#define A_SEARCH_VELOCITY           6000
#define A_LATCH_VELOCITY            LATCH_VELOCITY
#define A_LATCH_BACKOFF             4
#define A_ZERO_BACKOFF              34
...
#endif  // SETTINGS_BT_PLOTTER_H_ONCE
#endif