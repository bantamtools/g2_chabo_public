...
****************************************************/
/*
 * settings_bt_lfp.h - Bantam Tools CNC Milling Machine Project
...
#ifndef SETTINGS_BT_LFP_H_ONCE
#define SETTINGS_BT_LFP_H_ONCE
...
#define M1_TRAVEL_PER_REV           27                      //14 teeth/rev, 14 teeth per inch, belt driven 
#define M1_MICROSTEPS               8                       // 1mi  1,2,4,8,16,32
#define M1_POLARITY                 1                       // 1po  0=normal, 1=reversed

#define M2_MOTOR_MAP                AXIS_Y_EXTERNAL
#define M2_STEP_ANGLE               1.8
#define M2_TRAVEL_PER_REV           27                      //14 teeth/rev, 14 teeth per inch, belt driven 
...
#define M4_TRAVEL_PER_REV           27                     //14 teeth/rev, 14 teeth per inch, belt driven 
...
#define X_TRAVEL_MAX                762                 // xtr  travel between switches or crashes
...
#define X_LIMIT_SW_ACTIVE_STATE SWITCH_NO_ACTIVE_STATE
#define Y_LIMIT_SW_ACTIVE_STATE SWITCH_NO_ACTIVE_STATE
