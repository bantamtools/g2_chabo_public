...
****************************************************/
/*
 * settings_bt_cncmm.h - Bantam Tools CNC Milling Machine Project
...
#ifndef SETTINGS_BT_CNCMM_H_ONCE
#define SETTINGS_BT_CNCMM_H_ONCE
#include "main.h"
#ifdef CHABO_DCNC
/***********************************************************************/
/**** BT_CNCMM profile ***************************************/
...
#define JERK_MAX                    650   //300          // 650 million mm/(min^3)
#define JERK_HIGH_SPEED             1000  //500              // 1000 million mm/(min^3) // Jerk during homing needs to stop *fast*
#define VELOCITY_MAX                5060
#define SEARCH_VELOCITY             300    //100
...
#define X_TRAVEL_MAX                185                 // xtr  travel between switches or crashes
#define X_JERK_MAX                  500// 300             // xjm
...
#define Y_JERK_MAX                  JERK_MAX//250
...
#define P1_SPEED_HI              28000   // in RPM
#define P1_PHASE_LO              0.12025
#define P1_PHASE_HI              0.1735
#define P1_PWM_PHASE_OFF         0.1000
#define P1_PWM_K_VALUE           2.15
...
#endif  // SETTINGS_BT_CNCMM_H_ONCE
#endif