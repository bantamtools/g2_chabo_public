...
#define HELP_H_ONCE
	...
	stat_t help_boot_loader(nvObj_t *nv);//not used
	stat_t help_dfuboot_loader(nvObj_t *nv);//sme
        stat_t help_hw_reset(nvObj_t *nv);//sme
#else
	...
	stat_t help_dfuboot_loader help_stub//sme
        stat_t help_hw_reset help_stub //sme
