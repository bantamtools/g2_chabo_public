/*
 * g2_xio.h - extended IO functions
...
#include "g2core.h"
#include "g2_config.h"		// required for nvObj typedef
#include "main.h"
...
#define DEV_IS_DATA		(0x0002)		// device is set as a data channel
		// device is the primary control channel
