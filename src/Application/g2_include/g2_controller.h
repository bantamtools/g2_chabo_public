/*
 * g2_controller.h - g2core controller and main dispatch loop
...
#define OUTPUT_BUFFER_LEN 2048//11-13-2020 1024           // sme, double this 512 text buffer size
...
bool controller_parse_control(char *p);
 ...
 void _controller_set_connected(bool is_connected);//edge
void _reset_comms_mode();
