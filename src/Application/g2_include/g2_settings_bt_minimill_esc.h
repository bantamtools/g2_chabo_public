...
#define INIT_MESSAGE "Initializing configs to BT MINIMILL ESC settings"
...
#define P1_SPEED_HI              24000
#define P1_PHASE_LO              0.127
#define P1_PHASE_HI              0.196 
#define P1_PWM_PHASE_OFF         0.1000
#define P1_PWM_K_VALUE           1.8
